(define-library (ecraven gerbil-swank)
  ...
  (import (scheme base) (scheme file) (scheme write) (scheme read) (scheme eval) (scheme repl) (scheme process-context) (scheme load) (scheme cxr) (scheme char)
          ...
          (only (gerbil/gambit) open-tcp-server pp)
          (only (gerbil/core) hash-ref hash-put! hash-length make-hash-table exit values->list hash->list filter hash-table?) ;; values->list should go when let-values works
